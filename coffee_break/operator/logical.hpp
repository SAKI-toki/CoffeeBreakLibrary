...
COFFEE_BREAK_COMPOUND_ASSIGNMENT_OPERATABLE(compound_bit_and_logicable,
                                            compound_bit_and_logicabled, &=)
COFFEE_BREAK_COMPOUND_ASSIGNMENT_OPERATABLE(compound_bit_or_logicable,
                                            compound_bit_or_logicabled, |=)
COFFEE_BREAK_COMPOUND_ASSIGNMENT_OPERATABLE(compound_bit_xor_logicable,
                                            compound_bit_xor_logicabled, ^=)
