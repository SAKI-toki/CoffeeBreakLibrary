...
COFFEE_BREAK_FORWARD_UNARY_OPERATABLE(plus_unary_operatable,
                                      plus_unary_operatabled, +)
COFFEE_BREAK_FORWARD_UNARY_OPERATABLE(minus_unary_operatable,
                                      minus_unary_operatabled, -)
COFFEE_BREAK_FORWARD_UNARY_OPERATABLE(logical_negation_operatable,
                                      logical_negation_operatabled, !)
COFFEE_BREAK_FORWARD_UNARY_OPERATABLE(bit_logical_negation_operatable,
                                      bit_logical_negation_operatabled, ~)
