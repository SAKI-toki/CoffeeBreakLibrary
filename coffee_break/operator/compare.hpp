...
=============================================================================*/
#ifndef COFFEE_BREAK_OPERATOR_COMPARE_HPP
#define COFFEE_BREAK_OPERATOR_COMPARE_HPP
...
COFFEE_BREAK_ARITHMETIC_OPERATABLE(small_or_equal_comparable,
                                   small_or_equal_comparabled, <=)
COFFEE_BREAK_ARITHMETIC_OPERATABLE(big_or_equal_comparable,
                                   big_or_equal_comparabled, >=)

#endif // COFFEE_BREAK_OPERATOR_COMPARE_HPP