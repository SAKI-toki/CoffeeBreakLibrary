...
#define COFFEE_BREAK_UNARY_OPERATABLE(CLASS_NAME, CONCEPT_NAME, FORWARD_OPERATOR, BACK_OPERATOR) \
  ...
  {                                                                                              \
    ...
    {                                                                                            \
      template <typename U>                                                                      \
      static constexpr STD_NSS::true_type check(                                                 \
          decltype(FORWARD_OPERATOR STD_NSS::declval<U &>() BACK_OPERATOR, nullptr));            \
      template <typename>                                                                        \
      static constexpr STD_NSS::false_type check(...);                                           \
                                                                                                 \
    public:                                                                                      \
...
#define COFFEE_BREAK_FORWARD_UNARY_OPERATABLE(CLASS_NAME, CONCEPT_NAME, FORWARD_OPERATOR) \
  COFFEE_BREAK_UNARY_OPERATABLE(CLASS_NAME, CONCEPT_NAME, FORWARD_OPERATOR, )

//back_unary

#define COFFEE_BREAK_BACK_UNARY_OPERATABLE(CLASS_NAME, CONCEPT_NAME, BACK_OPERATOR) \
  COFFEE_BREAK_UNARY_OPERATABLE(CLASS_NAME, CONCEPT_NAME, , BACK_OPERATOR)

//unary

#define COFFEE_BREAK_FORWARD_AND_BACK_UNARY_OPERATABLE(CLASS_NAME, CONCEPT_NAME, OPERATOR)      \
  COFFEE_BREAK_FORWARD_UNARY_OPERATABLE(forward_##CLASS_NAME, forward_##CONCEPT_NAME, OPERATOR) \
  COFFEE_BREAK_BACK_UNARY_OPERATABLE(back_##CLASS_NAME, back_##CONCEPT_NAME, OPERATOR)
