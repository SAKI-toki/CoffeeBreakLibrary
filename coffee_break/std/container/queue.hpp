...
template <typename T>
inline constexpr bool is_queue_v = COFFEE_BREAK_NSS::details::is_queue<T>::value;
...
struct is_priority_queue<std::priority_queue<T, ContainerType, CompareType>> : STD_NSS::true_type
{
};

template <typename T>
inline constexpr bool is_priority_queue_v = COFFEE_BREAK_NSS::details::is_priority_queue<T>::value;
...
//priority_queue
template <typename... Types>
using this_is_priority_queue = COFFEE_BREAK_NSS::enable_if_nullptr_t<
    STD_NSS::conjunction_v<COFFEE_BREAK_NSS::details::is_priority_queue<Types>...>>;
template <typename... Types>
using this_is_not_priority_queue = COFFEE_BREAK_NSS::enable_if_nullptr_t<
    !STD_NSS::conjunction_v<COFFEE_BREAK_NSS::details::is_priority_queue<Types>...>>;
